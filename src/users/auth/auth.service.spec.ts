...
describe('AuthService', () => {
	...
	describe('register', () => {
		it('should register a new user successfully', async () => {
			...
			expect(userService.findOneByEmail).toHaveBeenCalledWith(createUserDto.email);
			...
			expect(result).toEqual(new RegisterResponse({ user: mockUser, accessToken: mockAccessToken }));
		});
	...
	describe('login', () => {
		it('should login user successfully with valid credentials', async () => {
			...
			expect(passwordService.verify).toHaveBeenCalledWith(password, mockUser.password);
			expect(jwtService.signAsync).toHaveBeenCalledWith({
				sub: mockUser.id,
				name: mockUser.name,
				roles: mockUser.roles,
