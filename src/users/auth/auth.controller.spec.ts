...
describe('AuthController', () => {
	...
	describe('login', () => {
		it('should login user successfully', async () => {
			...
			expect(result).toEqual(new LoginResponse({ accessToken: mockAccessToken }));
		});
	...
	describe('getProfile', () => {
		it('should return user profile successfully', async () => {
			...
			expect(userService.findOneById).toHaveBeenCalledWith(mockAuthRequest.user.sub);
	...
	describe('adminOnly', () => {
		it('should return admin response', async () => {
			...
			expect(result).toEqual(new AdminResponse({ message: 'This is for admins only' }));
		});
	});
});